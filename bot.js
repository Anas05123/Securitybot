...
client.on("message", (message) => {
   ...
   if (message.content.startsWith(prefix + "new")) {  
        ...
        if (!message.guild.roles.exists("name", "Helpers Team")) return message.channel.send(`لازم تسوي رتبة اسمها \`Helpers Team\` وتعطي البوت ادمنيتر حتا يقدر يسوي الرومات ويعدل برمشنات`);
